      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pb-6 border-b border-slate-800">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-white tracking-tight flex items-center gap-3">
            ...
            Relatorio Detalhado de Materiais
          </h1>
          <p className="text-slate-400 max-w-2xl text-sm">
            Visao agrupada por categorias, permitindo fiscalizacao minuciosa de materiais em reserva e materiais
            atualmente cautelados.
          </p>
        </div>
      </div>
